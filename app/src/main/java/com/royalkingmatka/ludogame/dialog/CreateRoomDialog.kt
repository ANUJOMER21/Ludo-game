...
import com.royalkingmatka.ludogame.databinding.DialogCreateRoomBinding
...
class CreateRoomDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        v = requireActivity().layoutInflater.inflate(R.layout.dialog_create_room, null)
        init()
        val builder = builder()
    ...
    private fun shareToWhatsapp() {
        ...
        try {
            ...
            requireActivity().toast("Whatsapp not installed.")
        }
    }
